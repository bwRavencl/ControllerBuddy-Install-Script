...
- Ensures you have [GnuPG](https://gnupg.org/), [cUrl](https://curl.se/), [Git](https://git-scm.com/), and [xmllint](https://gitlab.gnome.org/GNOME/libxml2) installed (*only on Linux*)
